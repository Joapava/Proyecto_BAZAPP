...
Widget llenarBarraCuenta()
{
  return Column(
          ...
          child: Container(
            ...
            child: const Text("Nombre cuenta",style: TextStyle(color: Color.fromRGBO(113, 147, 156,1.0), fontSize: 15),)
          ),
        ),
        ...
        Align(
          ...
          child: SizedBox(
            ...
            child: Container(
                    ...
                    child: const Text("admin",textAlign: TextAlign.center,style: TextStyle(color: Color.fromRGBO(113, 147, 156,1.0)),)
            ),
          ),
        ),
          ],
